...
################################################
############## EXERCICIO 1 #####################
# Questão A. O que o seguinte programa #########
# (dado na forma de pseucódigo) imprime? #######
# x = 2
# y = 5
# se y > 8 então
# y = y * 2
...
################################################
############## EXERCICIO 2 #####################
# Quantas vezes o trecho de pseudocódigo #######
# seguinte imprime 'oi'? (obs: na nossa pseudo #
# -linguagem, o laço inclui os extremos, ou ####
# seja, 1 até 4 significa 1, 2, 3, 4.) #########
################################################
""" ctt = 0
...
# quantos números são pares e também ###########
# divisíveis por 7? ############################
# Resposta: 183 ################################
################################################
...
# Para ela, um número é sortudo se ele contém ##
# o dígito 2 mas não o dígito 7. Então, na #####
# opinião dela, quantos números sortudos #######
# existem entre 18644 e 33087, incluindo os ####
# extremos? Resposta: 7995 #####################
################################################
